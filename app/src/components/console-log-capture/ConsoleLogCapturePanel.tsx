...
export const ConsoleLogCapturePanel = (props: ConsoleLogCapturePanelProps) => {
  ...
  const requestClearLogs = () => {
    if (consoleLogEntries().length === 0) return;
  ...
  return (
    <>
              ...
              fallback={
                ...
                >
                  <Text fontSize="sm" color="fg.default">
                    Capture is off. Turn it on to start recording console
                    output.
                  </Text>
                </Box>
              }
      ...
      <ConfirmDialog
        ...
        description="This will permanently remove all captured console text from the current session."
